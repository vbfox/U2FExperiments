...
namespace BlackFox.UsbHid.Win32
{
    ...
    public class Win32HidDevice : IHidDevice
    {
        ...
        public Win32HidOutputReport CreateOutputReport(byte id = 0)
        {
            var buffer = new byte[Information.Capabilities.OutputReportByteLength];
            return new Win32HidOutputReport(id, new ArraySegment<byte>(buffer));
        }

        IHidOutputReport IHidDevice.CreateOutputReport(byte id) => CreateOutputReport(id);
